    ...
    Account::SelfTradePreventionMode stp_mode)
{
    ...
    if (owner_.order_latency_bars_ > 0) {
        ...
        owner_.enqueue_deferred_order_locked_(due, [owner_ptr = &owner_, req_id, submitted_step, due, symbol, quantity, price, side, reduce_only, client_order_id, stp_mode](Account& acc, uint64_t step_seq) {
    ...
    return owner_.account_engine_->spot.place_order(symbol, quantity, price, side, reduce_only, client_order_id, stp_mode);
}
    ...
    Account::SelfTradePreventionMode stp_mode)
{
    ...
    if (owner_.order_latency_bars_ > 0) {
        ...
        owner_.enqueue_deferred_order_locked_(due, [owner_ptr = &owner_, req_id, submitted_step, due, symbol, quantity, side, reduce_only, client_order_id, stp_mode](Account& acc, uint64_t step_seq) {
    ...
    return owner_.account_engine_->spot.place_order(symbol, quantity, side, reduce_only, client_order_id, stp_mode);
}
    ...
    Account::SelfTradePreventionMode stp_mode)
{
    ...
    if (owner_.order_latency_bars_ > 0) {
        ...
        owner_.enqueue_deferred_order_locked_(due, [owner_ptr = &owner_, req_id, submitted_step, due, symbol, quote_order_qty, side, reduce_only, client_order_id, stp_mode](Account& acc, uint64_t step_seq) {
    ...
    return owner_.account_engine_->spot.place_market_order_quote(symbol, quote_order_qty, side, reduce_only, client_order_id, stp_mode);
}
