...
namespace QTrading::Dto::Market::Binance {
    ...
    struct TradeKlineDto : BaseMarketDto {
        ...
        /// @brief Constructs a fully-populated TradeKlineDto.
        ...
        TradeKlineDto(unsigned long long openTs,
            double openP,
            double highP,
            double lowP,
            double closeP,
