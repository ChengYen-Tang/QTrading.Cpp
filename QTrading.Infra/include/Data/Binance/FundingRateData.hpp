...
public:
    ...
    const QTrading::Dto::Market::Binance::FundingRateDto& get_latest() const;
    ...
    const QTrading::Dto::Market::Binance::FundingRateDto& get_funding(size_t index) const;
    ...
    using iterator = std::vector<QTrading::Dto::Market::Binance::FundingRateDto>::iterator;
    /// @brief Iterator over const FundingRateDto entries.
    using const_iterator = std::vector<QTrading::Dto::Market::Binance::FundingRateDto>::const_iterator;
...
private:
    ...
    std::vector<QTrading::Dto::Market::Binance::FundingRateDto> rates;  ///< In-memory funding storage
